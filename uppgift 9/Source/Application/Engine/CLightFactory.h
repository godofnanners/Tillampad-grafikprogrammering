...
public:
	...
	CPointLight* CreatePointLight(const CommonUtilities::Vector3<float>& aPos, const CommonUtilities::Vector3<float>& aRange, const CommonUtilities::Vector3<float>& aColor = {1,1,1});
